...
const InfiniteBanner = ({ text }) => (
  <div className="overflow-hidden whitespace-nowrap bg-[#261F1B] py-4 md:py-6 border-y border-[#B88A58]/20 select-none">
    ...
    >
      {[...Array(12)].map((_, i) => (
        <span key={i} className="text-[8px] md:text-[10px] uppercase tracking-[0.5em] md:tracking-[0.8em] text-[#B88A58] mx-6 md:mx-12 font-light">
          {text} •
        </span>
      ))}
    </motion.div>
...
const Heading = ({ subtitle, title, centered = false, color }) => (
  <div className={`mb-8 md:mb-12 ${centered ? 'text-center mx-auto' : 'text-left'}`}>
    <motion.span 
      ...
      className="text-[8px] md:text-[9px] uppercase text-[#B88A58] font-bold block mb-3 md:mb-4"
    >
      {subtitle}
    </motion.span>
    <motion.h2 
      ...
      <div className="flex items-center space-x-8">
        ...
        <div className="text-left max-w-xl text-pretty">
          ...
          <h3 style={{ fontFamily: config.fonts.serif }} className="text-2xl md:text-4xl text-[#261F1B] font-light italic leading-tight">
            Precisa de apoio jurídico? <span className="text-[#B88A58]">Vamos conversar.</span>
          </h3>
        </div>
      </div>
      <a 
        ...
        target="_blank"
        rel="noreferrer"
        className="group flex items-center justify-center space-x-4 w-full md:w-auto px-10 py-5 bg-[#261F1B] text-[#F9F7F2] text-[10px] md:text-[11px] uppercase tracking-[0.5em] font-bold hover:bg-[#B88A58] transition-all duration-700 shadow-xl shrink-0"
      >
...
const HomeView = ({ onNavigate }) => {
  ...
  return (
    <div ref={container} className="flex flex-col bg-[#F9F7F2]">
        ...
        <div className="max-w-7xl mx-auto w-full pt-20 md:pt-32 pb-12">
          <motion.div initial={{ opacity: 0, scale: 0.98 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 1.8 }} className="max-w-6xl text-left">
            <div className="flex items-center space-x-4 mb-8 md:mb-10">
                <div className="h-[1px] w-[60px] md:w-[100px] bg-[#B88A58]"></div>
                <span className="text-[10px] md:text-[12px] uppercase tracking-[0.4em] text-[#B88A58] font-bold">OAB/SP 496.897</span>
            </div>
            <h1 style={{ fontFamily: config.fonts.serif }} className="text-4xl md:text-6xl lg:text-7xl xl:text-[5rem] text-[#261F1B] leading-[1.2] md:leading-[1.1] font-light mb-12 select-none">
              Rigor técnico. <br />
              <span className="italic text-[#B88A58]">Soluções jurídicas personalizadas.</span>
            </h1>
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-10 md:space-y-0 md:space-x-20 text-pretty">
              <button onClick={() => onNavigate('contact')} className="w-full md:w-auto group relative px-10 py-6 md:px-14 md:py-7 bg-[#261F1B] text-[#F9F7F2] text-[10px] uppercase tracking-[0.4em] md:tracking-[0.5em] overflow-hidden shadow-2xl">
      ...
      <section className="py-24 md:py-40 bg-[#261F1B] text-[#F9F7F2] relative overflow-hidden">
         ...
         <div className="max-w-7xl mx-auto px-6 lg:px-12 grid grid-cols-1 lg:grid-cols-12 gap-16 md:gap-24 items-center relative z-10 text-pretty">
            ...
            <div className="lg:col-span-7 text-left">
               <div className="flex items-center space-x-4 mb-6">
                   <Award size={18} className="text-[#B88A58]" />
            ...
            <div className="lg:col-span-5">
               ...
               <div className="space-y-6 md:space-y-8">
                  <div className="flex items-center space-x-4 md:space-x-6 group">
                     <div className="w-12 h-12 md:w-14 md:h-14 bg-[#261F1B] flex items-center justify-center text-[#B88A58] shrink-0 transition-all group-hover:bg-[#B88A58] group-hover:text-white">
      ...
      <section className="pt-32 md:pt-48 pb-24 md:pb-32 px-6 lg:px-12 max-w-7xl mx-auto bg-[#F9F7F2]">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-24 items-center">
          ...
          <div className="lg:col-span-7 text-left text-pretty">
            <div className="flex items-center space-x-4 mb-6">
               <Award size={18} className="text-[#B88A58]" />
               <span className="text-[11px] uppercase tracking-[0.4em] text-[#B88A58] font-bold">OAB/SP 496.897</span>
            </div>
        ...
        <div className="lg:col-span-5 text-left">
          ...
          <div className="space-y-10 md:space-y-16 mt-10 md:mt-20 text-pretty">
            <div className="flex items-start space-x-6 md:space-x-8">
              <div className="w-12 h-12 md:w-14 md:h-14 bg-[#261F1B] flex items-center justify-center text-[#B88A58] shrink-0">
                 <Phone size={22} strokeWidth={1} />
              </div>
              <div>
                <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-[#B88A58] font-bold mb-2 md:mb-4 text-left">Directo</p>
                <a href="tel:+5511966020206" className="text-xl md:text-2xl font-light text-[#261F1B] tracking-widest hover:text-[#B88A58] transition-colors text-left text-pretty">+55 11 96602-0206</a>
              </div>
            </div>
            <div className="flex items-start space-x-6 md:space-x-8 text-pretty">
              ...
              <div>
                <p className="text-[9px] md:text-[10px] uppercase tracking-[0.3em] md:tracking-[0.4em] text-[#B88A58] font-bold mb-2 md:mb-4 text-left">Canal Oficial</p>
            ...
            <div className="pt-8 border-t border-[#261F1B]/10 flex items-center space-x-4">
               ...
               <div>
                  <p className="text-[10px] uppercase tracking-widest text-[#B88A58] font-bold text-pretty">Inscrição Profissional</p>
                  <p className="text-lg font-light text-[#261F1B] text-pretty">OAB/SP 496.897</p>
               </div>
            </div>
          </div>
        </div>
      ...
      <nav className={`fixed top-0 w-full z-[200] transition-all duration-1000 ${scrolled ? 'bg-[#F9F7F2]/95 backdrop-blur-md py-4 md:py-6 shadow-sm' : 'bg-transparent py-6 md:py-10'}`}>
        <div className="max-w-7xl mx-auto px-6 lg:px-12 flex justify-between items-center text-pretty text-left text-pretty text-left">
          <div className="cursor-pointer group" onClick={() => onNavigate('home')}>
            <h1 style={{ fontFamily: config.fonts.serif }} className="text-lg md:text-2xl tracking-[0.2em] md:tracking-[0.3em] font-light text-[#261F1B] uppercase">Daniela Simão</h1>
            <div className="h-[1px] w-0 group-hover:w-full bg-[#B88A58] transition-all"></div>
            <p className="text-[8px] tracking-[0.2em] uppercase text-[#B88A58] mt-1 font-bold">OAB/SP 496.897</p>
          </div>
          ...
          <button className="md:hidden text-[#261F1B] p-2 relative z-[300]" onClick={() => setIsOpen(!isOpen)}>
          ...
          >
            <div className="absolute inset-0 opacity-[0.03] pointer-events-none text-pretty text-left">
              <div className="grid grid-cols-6 h-full w-full">
                {[...Array(6)].map((_, i) => (
                  <div key={i} className="border-r border-[#261F1B] h-full text-pretty text-left"></div>
                ))}
              </div>
            </div>
            ...
            <div className="flex flex-col space-y-8 text-center relative z-10 text-pretty text-left">
              {menu.map((item, i) => (
                <motion.button 
                  ...
                  className={`text-4xl md:text-5xl font-serif italic text-[#261F1B] transition-colors hover:text-[#B88A58] ${current === item.id ? 'text-[#B88A58]' : ''} text-pretty text-left`}
                >
                  {item.label}
                </motion.button>
              ))}
...
const Footer = ({ onNavigate }) => (
  <footer className="bg-[#261F1B] text-[#F9F7F2] pt-24 md:pt-40 pb-16 md:pb-20 px-6 lg:px-12 text-center relative overflow-hidden text-pretty text-left">
    <div className="max-w-7xl mx-auto flex flex-col items-center relative z-10 text-left md:text-center text-pretty text-left">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-16 md:gap-24 border-t border-white/10 py-16 md:py-32 w-full text-[9px] md:text-[10px] uppercase tracking-[0.4em] md:tracking-[0.6em] font-light text-white/40 text-pretty text-left">
        ...
        <div className="flex flex-col items-center text-pretty text-pretty text-left">
           <h4 className="mb-8 md:mb-12 text-[#B88A58] font-bold uppercase tracking-widest text-center text-pretty text-left">Atendimento</h4>
        ...
        <div className="flex flex-col items-center text-pretty text-left">
           <h4 className="mb-8 md:mb-12 text-[#B88A58] font-bold uppercase tracking-widest text-center text-pretty text-left">Conectar</h4>
